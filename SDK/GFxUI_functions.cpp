...
// ()
// Parameters:
// struct FLoadingMovieMapInfo    LoadingInfo                    (Const, Parm, OutParm, NeedCtorLink)
...
// bool                           bGamepad                       (Parm)
void UGFxInteraction::DebugInputKey(int ControllerId, const struct FName& Key, TEnumAsByte<Core_EInputEvent> Event, float AmountDepressed, bool bGamepad)
{
