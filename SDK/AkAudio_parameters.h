...
struct UAkMusicDevice_Seek_Params
{
	class UAkSoundCue*                                 Sound;                                                     // (Parm)
...
struct UAkSoundSource_Seek_Params
{
	class UAkSoundCue*                                 Sound;                                                     // (Parm)
...
struct USeqAct_AkPlaySoundAndSeek_ToggleSoundFor_Params
{
	class AActor*                                      A;                                                         // (Parm)
	bool                                               bPlay;                                                     // (Parm)
};
...
struct USeqAct_AkPlaySoundAndSeek_ToggleSound_Params
{
	bool                                               bPlay;                                                     // (Parm)
};

// Function AkAudio.SeqAct_AkPlaySoundAndSeek.Activated
struct USeqAct_AkPlaySoundAndSeek_Activated_Params
{
};
