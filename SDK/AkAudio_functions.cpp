...
// TEnumAsByte<AkAudio_EBusEmitterType> BusType                        (Parm)
void AAkBusActor::RegisterReflectionEmitter(const struct FName& BusName, TEnumAsByte<AkAudio_EBusEmitterType> BusType)
{
...
// ()
// Parameters:
// TEnumAsByte<AkAudio_EPinnedAxisType> AxisToPin                      (Parm)
void AAkBusActor::SetPinnedAxis(TEnumAsByte<AkAudio_EPinnedAxisType> AxisToPin)
{
...
// TEnumAsByte<AkAudio_EAkEnvironmentType> EnvironmentType                (Parm)
void UAkDevice::SetSoundEnvironment(class AActor* Actor, TEnumAsByte<AkAudio_EAkEnvironmentType> EnvironmentType)
{
...
// ()
// Parameters:
// TEnumAsByte<AkAudio_EAkDynamicRangeType> Type                           (Parm)
void UAkDevice::SetDynamicRange(TEnumAsByte<AkAudio_EAkDynamicRangeType> Type)
{
...
// ()
// Parameters:
// TEnumAsByte<AkAudio_EAkOutputType> Type                           (Parm)
void UAkDevice::SetOutputType(TEnumAsByte<AkAudio_EAkOutputType> Type)
{
...
// TEnumAsByte<AkAudio_EAkListenerSpacialization> Value                          (Parm)
void UAkDevice::SetListenerSpatialization(class ULocalPlayer* Player, TEnumAsByte<AkAudio_EAkListenerSpacialization> Value)
{
...
// ()
// Parameters:
// float                          DeltaTime                      (Const, Parm)
void UAkMusicAnalysis::UpdateSmoothedMusicInfo(float DeltaTime)
{
	static auto fn = UObject::FindObject<UFunction>("Function AkAudio.AkMusicAnalysis.UpdateSmoothedMusicInfo");

	UAkMusicAnalysis_UpdateSmoothedMusicInfo_Params params;
...
// ()
// Parameters:
// struct FMusicAnalysisInfo      NewValues                      (Const, Parm, OutParm, NeedCtorLink)
void UAkMusicAnalysis::UpdateMusicInfo(struct FMusicAnalysisInfo* NewValues)
{
	static auto fn = UObject::FindObject<UFunction>("Function AkAudio.AkMusicAnalysis.UpdateMusicInfo");

	UAkMusicAnalysis_UpdateMusicInfo_Params params;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function AkAudio.AkMusicAnalysis.OnNewTrack");

	UAkMusicAnalysis_OnNewTrack_Params params;
	params.NewBPM = NewBPM;
...
// ()
// Parameters:
// class UAkMusicAnalysis*        ReturnValue                    (Parm, OutParm, ReturnParm)
class UAkMusicAnalysis* UAkMusicAnalysis::GetInstance()
{
	static auto fn = UObject::FindObject<UFunction>("Function AkAudio.AkMusicAnalysis.GetInstance");

	UAkMusicAnalysis_GetInstance_Params params;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function AkAudio.AkMusicAnalysis.EventMusicBar");

	UAkMusicAnalysis_EventMusicBar_Params params;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function AkAudio.AkMusicAnalysis.EventMusicBeat");

	UAkMusicAnalysis_EventMusicBeat_Params params;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function AkAudio.AkMusicAnalysis.EventNewMusicTrack");

	UAkMusicAnalysis_EventNewMusicTrack_Params params;
...
// Parameters:
// class UAkSoundCue*             Sound                          (Parm)
// float                          PositionSeconds                (Parm)
void UAkMusicDevice::Seek(class UAkSoundCue* Sound, float PositionSeconds)
{
	static auto fn = UObject::FindObject<UFunction>("Function AkAudio.AkMusicDevice.Seek");

	UAkMusicDevice_Seek_Params params;
	params.Sound = Sound;
	params.PositionSeconds = PositionSeconds;
...
// ()
// Parameters:
// TEnumAsByte<AkAudio_EAttenuationType> AttenuationType                (Parm)
void UAkSoundSource::SetAttenuationScaling(TEnumAsByte<AkAudio_EAttenuationType> AttenuationType)
{
...
// struct FName                   BusName                        (Parm)
// TEnumAsByte<AkAudio_EBusEmitterType> BusType                        (Parm)
void UAkSoundSource::RegisterReflectionEmitter(const struct FName& BusName, TEnumAsByte<AkAudio_EBusEmitterType> BusType)
{
...
{
	static auto fn = UObject::FindObject<UFunction>("Function AkAudio.AkSoundSource.Seek");

	UAkSoundSource_Seek_Params params;
	params.Sound = Sound;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function AkAudio.SeqAct_AkPlaySoundAndSeek.ToggleSoundFor");

	USeqAct_AkPlaySoundAndSeek_ToggleSoundFor_Params params;
	params.A = A;
	params.bPlay = bPlay;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function AkAudio.SeqAct_AkPlaySoundAndSeek.ToggleSound");

	USeqAct_AkPlaySoundAndSeek_ToggleSound_Params params;
	params.bPlay = bPlay;
...
// ()
void USeqAct_AkPlaySoundAndSeek::Activated()
{
	static auto fn = UObject::FindObject<UFunction>("Function AkAudio.SeqAct_AkPlaySoundAndSeek.Activated");

	USeqAct_AkPlaySoundAndSeek_Activated_Params params;
